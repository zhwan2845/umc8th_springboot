...
//    public final StringPath status = createString("status");  // StringPath로 정의되어 있어야 합니다.
    ...
    public final umc.springboot.domain.QMember member;

    public final umc.springboot.domain.QMission mission;

    public final EnumPath<umc.springboot.domain.enums.MissionStatus> status = createEnum("status", umc.springboot.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umc.springboot.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umc.springboot.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
